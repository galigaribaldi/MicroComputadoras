...
contador 	equ h'24'	;definimos contadotor en 24
valor1 		equ h'21'	;
valor2 		equ h'22'	;
valor3 		equ h'23'	;
cte1 		equ 20h;  cte vale 20*
...
loop2 		movlw h'07'	; cargar en w un 07
			movwf contador; mandar a la variable contador el valor w=7
			movlw h'80'; carga un 1h en W
			movwf PORTB; manda lo de w a port b =01h
 			call retardo	;llamada a la subrutina retardo
ciclo		rrf PORTB, 1  ; recorre a la derecha el bit de PortB
